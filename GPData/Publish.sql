...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL16.GPDATA\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL16.GPDATA\MSSQL\DATA\"
...
ALTER TABLE [dbo].[Appointment]
    ADD FOREIGN KEY ([BookingOrganizationId]) REFERENCES [dbo].[Organization] ([Id]);
...
GO
ALTER TABLE [dbo].[DiagnosticReport]
    ADD FOREIGN KEY ([Assigner]) REFERENCES [dbo].[Organization] ([Id]);
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Location]...';


GO
ALTER TABLE [dbo].[Location]
    ADD FOREIGN KEY ([PartOfID]) REFERENCES [dbo].[Location] ([Id]);
...
GO
ALTER TABLE [dbo].[Location]
    ADD FOREIGN KEY ([ManagingOrganizationID]) REFERENCES [dbo].[Organization] ([Id]);
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Organization]...';
...
GO
ALTER TABLE [dbo].[Organization]
    ADD FOREIGN KEY ([PartOfID]) REFERENCES [dbo].[Organization] ([Id]);
...
GO
ALTER TABLE [dbo].[Organization]
    ADD FOREIGN KEY ([ContactID]) REFERENCES [dbo].[Contact] ([Id]);
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Qualification]...';


GO
ALTER TABLE [dbo].[Qualification]
    ADD FOREIGN KEY ([IssuerID]) REFERENCES [dbo].[Organization] ([Id]);
...
GO
ALTER TABLE [dbo].[Qualification]
    ADD FOREIGN KEY ([AssignerID]) REFERENCES [dbo].[Organization] ([Id]);
